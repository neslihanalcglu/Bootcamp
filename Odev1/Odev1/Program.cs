...
namespace Odev1
{
    internal class Program
    {
        ...
        Ticket:
            ...
            Console.WriteLine("Giriş yapmak için kayıtlı TC Kimlik No'nuzu giriniz: \n");
        Ticket3:
            string tcNo;
            tcNo= HiddenPassword();
            //Console.ReadLine();
            ...
            var IsUser = userList.Any(x => x.TcKimlikNo == tcNo);
            User? user;
            if (IsUser)
            {
                ...
                Console.Clear();
                user = userList.Find(x => x.TcKimlikNo == tcNo);
            ...
            {
                Console.WriteLine("Kayıtlı kullanıcı bulunamadı. TC Kimlik Numaranızı yanlış giriğinizi düşünüyorsanız 1'i , " +
            ...
            Ticket2:
                ...
                Ticket5:
                        ...
                        Console.WriteLine("Giriş yapmak için TC Kimlik No'nuzu giriniz: \n");
                        goto Ticket3;
